...
console.log('tyrannosaurus weighs: ' + dino1.weight);

// What was the diet of a velociraptor?
console.log(`diet of a velociraptor is:  ${dino2.diet}`);

// How long was a stegosaurus?
console.log(`a stegosaurus length is: ${dino3.length}`);

// What time period did tyrannosaurus live in?
console.log(`time period of a tyrannosaurs: ${dino1.period}`);

// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
dino1.roar = function() {
	return 'RAWERSRARARWERSARARARRRR';
};
console.log(`Listen to this! ${dino1.roar()}`);
...
const populationTotal = zooAnimals.reduce((acc, element) => {
	return element.population + acc;
}, 0);
console.log("Population total of: " + populationTotal);
